...
import 'package:vatrina_shop/models/http_exception.dart';
          ...
          Container(
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: [
                  Color.fromRGBO(237, 236, 238, 1.0).withOpacity(0.5),
                  Color.fromRGBO(243, 242, 238, 1.0).withOpacity(0.9),
                ],
              ...
              child: Column(
                ...
                children: [
                  Flexible(child: Container(
                    ...
                    child: Text("login", style: TextStyle(color: Theme.of(context).accentTextTheme.headline6.color,
                    fontSize: 50,
                    fontFamily: 'Anton',
                    ),
                    ),
